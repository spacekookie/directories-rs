...
#[cfg(target_os = "linux")]   pub use lin::OsBackend as OsBackend;
#[cfg(target_os = "windows")] pub use win::OsBackend as OsBackend;
#[cfg(target_os = "macos")]   pub use mac::OsBackend as OsBackend;
...
impl BaseDirectories {
    ...
    pub fn config_dir() -> Path {
        OsBackend::config_dir.as_path()
    }
    ...
    /// | Windows | `{FOLDERID_RoamingAppData}`           | C:\Users\Eve\AppData\Roaming\           |
    pub fn data_roaming_dir() -> Path {
        OsBackend::data_dir.as_path()
    }
    ...
    pub fn data_dir() -> Path {
        OsBackend::data_local_dir.as_path()
    }
    ...
    /// | macOS   | –                                                              | –                        |
    /// | Windows | –                                                              | –                        |
    pub fn executable_dir() -> Option<Path> {
        OsBackend::executable_dir.as_ref().map(|p| p.as_path())
    }
    ...
    /// | macOS   | –                  | –               |
    /// | Windows | –                  | –               |
    pub fn runtime_dir() -> Option<Path> {
        OsBackend::runtime_dir.as_ref().map(|p| p.as_path())
    }
    ...
    pub fn audio_dir() -> Path {
        OsBackend::audio_dir.as_path()
    }
    ...
    pub fn desktop_dir() -> Path {
        OsBackend::desktop_dir.as_path()
    }
    ...
    pub fn document_dir() -> Path {
        OsBackend::document_dir.as_path()
    }
    ...
    pub fn download_dir() -> Path {
        OsBackend::download_dir.as_path()
    }
    ...
    /// | Windows | –                                                      | –                             |
    pub fn font_dir() -> Option<Path> {
        OsBackend::font_dir.as_ref().map(|p| p.as_path())
    }
    ...
    pub fn picture_dir() -> Path {
        OsBackend::picture_dir.as_path()
    }
    ...
    pub fn public_dir() -> Path {
        OsBackend::public_dir.as_path()
    }
    ...
    pub fn template_dir() -> Option<Path> {
    ...
    pub fn video_dir() -> Path {
        OsBackend::video_dir.as_path()
    }
}
